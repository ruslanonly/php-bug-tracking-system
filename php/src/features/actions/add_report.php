<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $baseQuery = "INSERT INTO report (name, product_id, priority, problem, playback_steps, actual_result, expected_result) VALUES ('$name', $product_id, $priority, $problem, '$playback_steps', '$actual_result', '$expected_result')";
